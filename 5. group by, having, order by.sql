...
SELECT 
    COUNT(direct_manager_emp_no) -- null을 빼고 집계 
FROM tb_emp                      -- select * 은 null 포함
;
...
SELECT 
    ...
    , addr
FROM tb_emp
ORDER BY emp_nm ASC -- ASC 디폴트 생략 가능 
;
